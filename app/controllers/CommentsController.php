...
class CommentsController extends BaseController {
	...
	public function newComment(Post $post)
	{
		...
		if($valid->passess())
		{
			...
			$comment->approved = 'no';  http://ruckuszd02.baruch.cuny.edu/user/guest_login.jsp?cookie=&redirecturl=http%3a%2f%2fwww%2egstatic%2ecom%2fgenerate_204
			$post->comments()->save($comment);

			return Redirect::to(URL::previous().'#reply')->with('success', 'Comment has been submitted and pending for approval!');
		}
		else
		{
