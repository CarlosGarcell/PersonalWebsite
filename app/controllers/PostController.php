...
class PostController extends BaseController {
	...
	public function listPost()
	{
		...
		$this->layout->title = 'Post listsings';
	...
	public function showPost()
	{
		...
		$this->layout->main = View::make('bhome')->nest('content', 'posts.single', compact('post', 'comments'));
	}
	...
	public function savePost()
	{
		...
		{
			return Ridirect::back()->withErrors($valid)->withInput();
		}
	}
